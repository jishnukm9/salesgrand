...
admin.site.register(ServiceInformations)
admin.site.register(ServiceChargeRequests)
admin.site.register(ServiceChat)
admin.site.register(Language)
admin.site.register(ProductPriceList)
admin.site.register(LiveStreamUrl)
admin.site.register(InstallationTax)
admin.site.register(StockAdjustment)
admin.site.register(BroadcastNotificationMobileApp)
admin.site.register(ServiceDiscountDetails)
